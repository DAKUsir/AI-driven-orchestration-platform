...
import {
  ...
  Loader2, X, Sparkles, Crown, Search
} from 'lucide-react'
              ...
              {showJoin && (
                <div className="space-y-2">
                  <input
                    ...
                    className="input text-sm font-mono tracking-widest text-center"
                    maxLength={6}
                    id="join-group-code"
                  />
                  {error && <p className="text-xs" style={{ color: 'var(--danger)' }}>{error}</p>}
        ...
        <div className="flex-1 overflow-y-auto space-y-0.5">
          ...
          {filteredGroups.map((group) => (
            <button
              ...
              style={{
                background: activeGroup?._id === group._id ? 'var(--accent-muted)' : 'transparent',
                border: `1px solid ${activeGroup?._id === group._id ? 'var(--accent-border)' : 'transparent'}`,
              }}
              onMouseEnter={e => {
      ...
      <div className="flex-1 flex flex-col card overflow-hidden">
        {!activeGroup ? (
          <div className="flex-1 flex flex-col items-center justify-center text-center px-4">
            ...
            <p className="text-sm" style={{ color: 'var(--text-muted)', maxWidth: '280px' }}>
          ...
          <>
            ...
            >
              ...
              <div className="flex items-center gap-1">
                ...
                <button
                  onClick={() => leaveGroup(activeGroup._id)}
                  className="btn btn-ghost btn-sm btn-icon"
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-1">
                {hasMore && (
                  <button
                    ...
                    className="btn btn-ghost btn-sm w-full text-xs mb-2"
                    style={{ color: 'var(--text-muted)' }}
                  >
                    ...
                    >
                      ...
                      <div className="max-w-[75%]">
                        ...
                        <div
                          ...
                          style={isMe
                            ? { background: 'var(--accent)', color: '#ffffff', borderBottomRightRadius: '4px' }
                        ...
                        <p
                          className={`text-[10px] mt-0.5 ${isMe ? 'text-right mr-1' : 'ml-1'} opacity-0 group-hover:opacity-100 transition-opacity`}
                            ...
                            <div className="flex-1 min-w-0">
                              <p className="text-xs font-medium truncate" style={{ color: 'var(--text-primary)' }}>
                                ...
                                {member._id === activeGroup.createdBy?._id && (
                                  <Crown className="w-3 h-3 inline ml-1" style={{ color: '#f59e0b' }} />
                                )}
                              </p>
